...
import com.mine.zhuo.learnandroid.grantor.PermissionListener;
import com.mine.zhuo.learnandroid.grantor.PermissionsUtil;
...
public class LoaderActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_image_loader);

        PermissionsUtil.TipInfo tip = new PermissionsUtil.TipInfo("",
               "", "",
               "");
...
//            if (!TextUtils.isEmpty(SharedPreferencesUtil.getInstance(context).getAccessToken())) {
//                getShowMerchantInfo();
//            } else {
//                SharedPreferencesUtil.getInstance(context).setAccessToken("");
...
//            }
    ...
    private void initView() {
        ...
        recyclerView.setAdapter(new ImageLoaderAdapter(dataList,LoaderActivity.this));
    }
